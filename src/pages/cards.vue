<template>
  ...
  <main class="min-h-screen px-8 py-32">
    ...
    <div class="grid grid-cols-none justify-center gap-4 md:grid-cols-2" v-else>
      <div
        :key="character.id"
        class="flex cursor-pointer flex-col justify-between gap-6 rounded-xl border border-grey-700 bg-grey-800 p-4 transition duration-300 ease-in-out hover:-translate-y-0.5 hover:bg-grey-700 hover:bg-opacity-60 hover:shadow"
